...
One-sided inverses for rectangular matrices, the two-sided inverse of a square matrix,
the list of equivalent conditions for invertibility, and computing inverses by row
reduction.
